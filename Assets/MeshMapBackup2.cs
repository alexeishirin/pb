...
public class MeshMapBackup2 : MonoBehaviour {
 /* public MapGenerationSettings mapGenerationSettings;
  ...
  public void drawMap() {
    ...
    calculateMapBounds();
    this.surfaceCurving = TerrainHelper.generateSurfaceCurving(top, left, bottom, right);
    ...
    foreach (Triangle triangle in mapTriangulation.Triangles) {
      ...
      float height1 = TerrainHelper.getHeight(vertex1.toVector3(), vertex1.hex, this.surfaceCurving, this.left, this.bottom, this.getHexSize(), elevatedHeightmap, mountainHeightmap);
      float height2 = TerrainHelper.getHeight(vertex2.toVector3(), vertex2.hex, this.surfaceCurving, this.left, this.bottom, this.getHexSize(), elevatedHeightmap, mountainHeightmap);
      float height3 = TerrainHelper.getHeight(vertex3.toVector3(), vertex3.hex, this.surfaceCurving, this.left, this.bottom, this.getHexSize(), elevatedHeightmap, mountainHeightmap);
